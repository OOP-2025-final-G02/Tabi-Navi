...
### アピールポイント
- 旅行プランを生成することでプランを考える時間が減る
- 入力するだけで最適な旅行プランが完成する
- 予算内で旅行プランを組むことができる
- 興味のあることに合わせた旅行プランを組むことができる
- 旅行プランに絶対に行きたいところを含められる
- 生成された旅行プランを部分的に編集できる
- 生成されたプランの場所の概算費用やおすすめポイント、評価がわかる
- 過去に生成したプランを見れる
- 視覚的でわかりやすいUI
- 予定を詰め込みすぎて時間が足りなくなることを防げる
- 臨機応変にアイデアを出してもらえる
- 行く場所がなくなって時間が余ってしまうことを防げる
- プランごとに名前をつけれる
- 同じ目的地でも様々なプランを簡単に作り、比較できる
- pdfで出力して印刷し、旅のしおりのようにできる
- pdfで他の人と共有できる
